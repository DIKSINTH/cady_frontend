    ...
    >
      ...
      <div className="p-3 space-y-2">
        ...
        <DropdownNav
          ...
          routes={["/android-app", "/ios-app", "/cross-platform"]}
        />
        ...
        <DropdownNav
          ...
          routes={["/logo-design", "/visiting-card"]}
        />
        ...
        <DropdownNav
          ...
          items={["View Banners", "Create Banner"]}
          routes={["/view-banners", "/create-banner"]}
        />
        ...
        <DropdownNav
          ...
          routes={["/view-testimonials", "/view-testimonial-content"]}
        />
        ...
        <DropdownNav
          ...
          items={["View Reviews", "Add Review"]}
          routes={["/view-reviews", "/add-review"]}
        />
        ...
        <DropdownNav
          ...
          items={["View Services", "Create Service"]}
          routes={["/view-services", "/create-service"]}
        />
        ...
        <DropdownNav
          ...
          items={["View Whychooseus", "Create Whychooseus"]}
          routes={["/view-whychooseus", "/create-whychooseus"]}
        />
        ...
        <DropdownNav
          ...
          items={["View Howweworks", "Create Howwework"]}
          routes={["/view-howweworks", "/create-howwework"]}
        />

        <NavItem icon={<FiStar />} label="Fact" open={open} route="/fact" />
        <NavItem
          icon={<FiSettings />}
          label="Settings"
          open={open}
